...
func connected_to_server():
	...
	SendPlayerInformation.rpc_id(
		1, "Player " + str(globalScript.Players.size() + 1), multiplayer.get_unique_id()
	)
...
@rpc("any_peer", "call_local") func update_dean_id(id):
